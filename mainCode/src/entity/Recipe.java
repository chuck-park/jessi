...
public class Recipe {
  ...
  String a = "<html><br><br>부대찌개<br>"
			  +"조리법<br>"
	  		+ "<br><br>1. 냄비에 육수 재료를 넣고 한소끔 끓여 멸치 육수 3컵(600ml)을 만든다.<br>"
	  		+ "<br><br>2. 볼에 양념 재료를 넣고 골고루 섞는다.<br>"
	  		+ "<br><br>3. 통조림 햄은 0.5cm 두깨로 썰고 소시지는 어슷 썬다. 다진 돼지고기는 청주 1큰술과 후춧가루 약간에 버무려 재운다.<br>"
	  		+ "<br><br>4. 대파는 어슷 썰고 양파는 채 썬다.<br>"
	  		+ "<br><br>5. 냄비에 햄, 소시지, 다진 돼지고기, 김치, 떡국떡, 양파, 대파, 삶은 마카로니, 통조림 콩을 넣는다."
	  		+ "<br>(떡국떡은 물에 담가 두었다가 넣는다.)<br>"
	  		+ "<br><br>6. 양념과 육수를 넣고 끓인다.(간이 부족하면 소금으로 간한다.)<br></html>";
  ...
  String c="<html><br><br>낙지볶음<br><br><br>1. 낙지는 가위로 머리 한쪽을 잘라 뒤집어 내장을 떼어낸다. 머리와 다리를 연결하는 부분의 눈을 자르고 다리를 뒤집어 안쪽에 있는 뼈를 뺀다."
  		+ "<br> 볼에 낙지와 밀가루를 넣고 바락바락 주물러 씻은 후 흐르는 물에 깨끗이 헹군다."
  		+ "<br> 끓는 물에 넣어 살짝 데친 후 체에 밭쳐 물기를 뺀다."
  		...
  		,d="<html><br><br>배추김치<br><br><br>1. 배추는 밑동을 자르고 겉잎을 떼어낸다. 배추 밑동이 위를 향하도록 세우고 밑동 부분의 1/3지점까지 칼집을 내어 양손으로 반을 쪼갠다. "
  				...
  				+ "<br> 떼어낸 겉잎을 함께 절인다."
  				+ "<br><br><br>3. 절인 배추는 찬물에 2~3번 헹군 후 30분 시간 체에 밭쳐 물기르 뺀다."
  				+ "<br><br><br>4. 무는 껍질을 벗긴 후"
  				+ ".5cm 두께로 채 썬다. 쪽파, 미나리, 갓은 깨끗이 씻어 체에 밭쳐 물기를 뺀 후 3cm 길이로 썬다."
  				+ "<br><br><br>5. 새우젓은 곱게 다진다."
  				+ "<br><br><br>6. 볼에 무와 고춧가루, 소금을 넣고 버무려 고춧물을 들인다."
  				...
  				+ "<br> 저장용기에 차곡차곡 담고 남은 양념에 소금과 물 1컵을 담고 양념을 씻어내 김치 위에 붓는다. "
  				+ "<br>실온에서 하룻동안 숙성한 후 냉장실에서 익혀 먹는다.</html>"
  		,e="<html><br><br>된장찌개"
  				+ "<br><br><br>1. 냄비에 국물용 멸치와 물을 넣고 한소끔 끓여 체에 걸러 멸치 육수를 2컵(400ml)을 만든다."
  				+ "<br>(국물용 멸치의 머리와 내장은 떼어내면 멸치 육수의 쓴맛이 없어진다.) 무는 사방 3cm 크기로 납작하게 썬다"
  				+ "<br>. 두부는 사방 2cm 크기로 깍뚝 썰고 애호박은 0.5cm 두께로 4등분한다. 청양고추와 대파는 송송 썬다. "
  				+ "<br>팽이버섯은 밑동을 제거한 후 가닥가닥 뜯는다."
  				+ "<br><br><br>2. 냄비에 멸치 국물을 붓고 체에 된장을 올려 풀어준다."
  				+ "<br><br><br>3. 무를 넣고 푹 익도록 끓인다."
  				+ "<br><br><br>4. 대파, 버섯, 고춧가루를 넣고 한소끔 끓인다.(중간 중간에 떠오르는 거품을 걷어낸다.)</html>"
  		,f=" <html><br><br>갈치조림"
  				+ "<br><br><br>1. 갈치는 지느러미와 내장을 제거하고 4~5토막으로 썬다. 칼로 비늘을 긁어 흐르는 물에 헹군다. "
  				+ "<br>대파, 마늘, 생강은 가늘게 채 썬다."
  				+ "<br><br><br>2. 작은 볼에 양념 재료와 01의 대파, 마늘, 생강을 넣어 골고루 섞는다."
  		...
  		,g="<html><br><br>홍합탕"
  				+ "<br><br><br>1. 홍합은 껍데기에 붙은 이물질을 제거하고 깨끗이 씻는다."
  				+ "<br><br><br>2. 무는 3cm 길이의 사각형 모양으로 썰고 붉은 고추, 풋고추는 어슷썬다."
  				+ "<br><br><br>3. 향신 채소는 다듬어 깨끗이 씻어 조리용 망에 담는다."
  				+ "<br><br><br>4. 냄비에 물을 붓고 홍합, 무, 향신 채소를 넣어 푹 끓인다."
  				+ "<br><br><br>5. 홍합 국물이 우러나면 향신 채소는 빼고 붉은 고추, 풋고추를 넣어 소금으로 간한다.</html>"
  		,h="<html><br><br>볶음밥"
  				+ "<br><br><br>1. 당근은 곱게 채썰어 잘게 다진다."
  				+ "<br><br><br>2. 파프리카는 씨를 빼고 0.5㎝ 크기로 잘게 썬다."
  				+ "<br><br><br>3. 양파는 곱게 다진다."
  				+ "<br><br><br>4. 준비된 모든 야채를 넣고 팬에 기름을 두르고 소금 1작은술을 넣고 볶은 후 밥을 섞어가면서 볶는다."
  				+ "<br><br><br>5. 볶은 밥을 준비된 접시에 담고 밥 주위를 옥수수로 장식한다.</html>"
  		,i="<html><br><br>미역초무침"
  				+ "<br><br><br>1. 마른미역을 미지근한 물에 담가 10분 이상 충분히 불린다."
  				+ "<br><br><br>2. 불린 미역을 체에 밭쳐 물기를 뺀 다음 손으로 물기를 꼭 짜고 한입크기로 썬다."
  				+ "<br><br><br>3. 오이는 0.2cm 두께로 둥글게 썬 뒤 소금을 넣고 버무려 5분 정도 절인다."
  				+ "<br><br><br>4. 절인 오이를 찬물에 가볍게 헹구고 체에 밭쳐 물기를 뺀 다음 손으로 물기를 꼭 짠다."
  				+ "<br><br><br>5. 볼에 분량의 양념 재료를 섞어 준비한다."
  				+ "<br><br><br>6. 볼에 미역, 오이, 양념을 넣고 고루 버무린 다음 그릇에 담아 완성한다.</html>"
  		,j="<html><br><br>제육볶음"
  				+ "<br><br><br>1. 돼지고기는 3cm두께로 썰어 청주, 소금, 후춧가루를 10분간 재운다."
  				+ "<br><br><br>2. 01에 양념 재료를 넣고 조물조물 버무려 20분간 더 재운다."
  				+ "<br><br><br>3. 양배추, 당근, 양파는 사방 3cm 크기로 썰고 대파, 청양고추, 홍고추는 어슷 썬다."
  				+ "<br><br><br>4. 달군 팬에 식용유를 두르고 재워둔 돼지고기를 넣고 볶다가 양배추, 당근, 양파, "
  				+ "<br>대파, 청양고추, 홍고추를 넣고 볶는다.</html>"
  		,k="<html><br><br>닭개장"
  				+ "<br>1. 통닭을 핏줄과 내장을 말끔히 떼어 내고 끓이다가 도중에 "
  				+ "<br>파, 마늘, 생강을 넣어 뼈에서 살이 쉽게 떨어질 때까지 2시간 이상 삶는다."
  				+ "<br>2. 닭이 물러지면 건져서 뼈를 발라내고 살을 찢어 놓고, 국물은 식혀서 기름을 걷어낸다."
  				+ "<br>3. 파는 7cm 길이로 대강 가르고, 숙주는 씻어서 각각 끓는 물에 데쳐 내고, 삶은 고사리는 단단한 부분을 다듬는다."
  				+ "<br>4. (가)의 양념 중 먼저 고춧가루만 그릇에 담고 기름을 조금씩 넣으면서 "
  				+ "<br>고루 저어서 잘 섞이면 나머지 조미료를 모두 넣고 고루 섞는다."
  				+ "<br>5. 닭 국물에 고추장을 풀어 끓이다가 닭고기와 데친 채소를 ④의 양념으로 고루 무쳐서 넣고 끓이다가"
  				+ "<br> 소금으로 간을 맞춘다. 달걀을 풀어 살짝 익혀도 맛있다.</html>"
  		,l="<html><br><br>육개장"
  				+ "<br>1. 쇠고기(양지머리)는 덩어리째 냉수에 담가 핏물을 빼고 두꺼운 솥에 물을 부어 "
  				+ "<br>펄펄 끓으면 고기와 무를 넣고 끓어 오르면 불을 줄이고 고기가 무르게 익을 때까지 은근히 끓인다."
  				+ "<br>2. 쇠고기가 충분히 무르면 건져내어 결대로 찢어두고 무는 납작납작하게 썬다."
  				+ "<br>3. 국물 위의 뜨는 기름을 제거하고 육수는 면보에 걸러둔다."
  				+ "<br>4. 대파는 8㎝ 길이로 토막 내어 끓는 물에 살짝 데쳐 내어 길이로 찢어둔다."
  				+ "<br>5. 숙주는 끓는 물에 데치고, 삶아서 부드럽게 불린 고사리와 토란대는 7㎝ 정도로 잘라서 굵으면 세로로 찢어 둔다."
  				+ "<br>6. 쇠고기, 숙주, 대파, 고사리, 토란대에 밑양념을 하여 3의 국물에 넣어 맛이 "
  				+ "<br>어우러지도록 끓인 다음 간을 맞춘다.</html>"
  		,m="<html><br><br>스크램블"
  				+ "<br><br><br>1. 볼에 달걀, 우유, 소금을 넣고 젓가락으로 잘 풀어 달걀물을 만든다."
  				+ "<br><br><br>2. 달군 팬에 식용유를 두르고 달걀물을 붓는다. "
  				+ "<br>가장자리가 익기 시작하면 젓가락으로 둥글게 저어가며 익힌다.</html>"
  		,n="<html><br><br>치즈밥"
  				+ "<br>1. 밥에 기름을 뺀 참치와 옥수수 통조림, 자른 양파을 넣어준다."
  				+ "<br>2. 케첩과 굴소스를 넣고 섞는다."
  				+ "<br>3. 냄비나 뚝배기에 식용류를 살짝 바른다."
  				+ "<br>4. 비벼진 밥을 담고 치즈를 위에 뿌린다."
  				+ "<br>5. 3~5분정도 데워준다.</html>"
  		,o="<html><br><br>베이컨 볶음밥"
  				+ "<br><br><br>1. 베이컨은 1×7cm 길이로 자른다."
  				+ "<br><br><br>2. 피망은 4cm 길이로 채썬다."
  				+ "<br><br><br>3. 파르메산 치즈는 칼로 얇게 썬다."
  				+ "<br><br><br>4. 팬을 달군 후 베이컨을 굽는다."
  				+ "<br><br><br>5. 베이컨을 구운 팬에 밥을 넣어 볶아 둔다."
  				+ "<br><br><br>6. 토마토 소스를 넣어 볶는다."
  				+ "<br><br><br>7. 밥을 넣어 볶으면서 간을 하고 베이컨, 치즈를 넣는다. 간은 간장으로 한다.</html>"
  		,p="<html><br><br>참치마요"
  				+ "<br>1. 닭고기를 볶는다."
  				+ "<br>2. 채소는 식용유 두른 팬에 볶다 양념 넣어서 볶아주세요. 센불에서 빠르게 살짝만 볶습니다."
  				+ "<br>3. 볶음밥은 먼저 식용유 두른 팬에 소금 약간 넣고 섞은 계란을 넣어 볶아 살짝 익혀 둔 뒤 덜어 내고 식용유와"
  				+ "<br> 대파를 넣어 향을 낸 후 밥을 넣어 볶습니다."
  				+ "<br>4. 양념을 넣어 볶다 소금, 후추, 볶은 계란을 넣고 고루 섞은 후 다른 재료와 함께 접시에 담아 냅니다."
  				+ "<br>5. 위에 마요네즈를 뿌려준다</html>"
  		,q="<html><br><br>고추참치달걀말이"
  				+ "<br>1. 계란을 풀어 소금간을 한다."
  				+ "<br>2. 계란물을 프라이팬에 약간 붓는다. "
  				+ "<br>3. 적당히 익으면 계란을 말고 다시 계란물을 붓는다."
  				+ "<br>4. 두번정도 부은 후 고추참치를 계란 위에 얹는다."
  				+ "<br>5. 계란을 말면 고추참치 계란말이!!</html>"
  		,r="<html><br><br>버섯리조또"
  				+ "<br>1. 버섯을 센 불에 볶는다."
  				+ "<br>2. 다른 팬에 마늘과 양파를 넣고 볶는다."
  				+ "<br>3. 양파가 투명해지면 쌀을 넣고 볶는다."
  				+ "<br>4. 쌀이 어느정도 익으면 치즈를 넣는다."
  				+ "<br>5. 버섯을 넣고 소금, 후추로 간을 한다."
  				+ "<br>6. 뚜껑을 덮어 2~3분간 기다린다.</html>"
  		,s="<html><br><br>스팸김치덮밥"
  				+ "<br><br><br>1. 김치는 1cm정도의 폭으로 네모지게 썬다."
  				...
  				+ "<br><br><br>4. 물, 고추장, 설탕을 넣는다."
  				+ "<br><br><br>5. 그릇에 밥을 담고 스팸김치볶음을 얹어 완성한다.</html>"
  		,t="<html><br><br>콩나물국"
  				+ "<br><br><br>1. 냄비에 국물용 멸치를 넣고 한소끔 끓여 멸치 육수를 7컵(1,400ml) 만든다. 대파는 어슷 썬다."
  				+ "<br><br><br>2. 01에 콩나물을 넣고 뚜껑을 덮어 콩나물이 익을 때까지 끓인다."
  				+ "<br><br><br>3. 뚜껑을 열고 대파, 마늘, 고춧가루를 넣고 끓인다.(기호에 따라 고춧가루 양을 가감한다.)"
  				+ "<br><br><br>4. 소금으로 간한다.</html>";
